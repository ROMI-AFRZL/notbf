...
def main(self, cookie, url, config):
	flist = raw_input('\n\033[0;95m\xe2\x80\xa2 \033[0;93mMasukkan link daftar teman \033[0;91m:\033[0;96m ')
	try:
		domain = flist.split('//')[1].split('/')[0]
		flist = flist.replace(domain, 'mbasic.facebook.com')
	except IndexError:
		exit('\n\033[0;95m\xe2\x80\xa2 \033[0;91mLink salah!\033[0m')
	...
	while True:
		try:
			...
			print('\n\033[0;95m\xe2\x80\xa2 \033[0;91mInterupsi Kunci, berhenti!!\033[0m')
			break
	try:
