...
def main(self, cookie, url, config):
	post = raw_input('\n\033[0;95m\xe2\x80\xa2 \033[0;97mMasukan url post \033[0;91m:\033[0;93m ')
	try:
		domain = post.split('//')[1].split('/')[0]
		post = post.replace(domain, 'mbasic.facebook.com')
	except IndexError:
		exit('\n\033[0;95m\xe2\x80\xa2 \033[0;91mUrl salah!\033[0m')
	url_likes = None
	...
	try:
		max = int(raw_input('\033[0;97mBerapa banyak ? \033[0;97m[\033[0;93mMax \033[0;91m: \033[0;93m1000\033[0;97m] \033[0;91m:\033[0;93m '))
	except ValueError:
